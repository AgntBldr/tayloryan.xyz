...
// 0. Determine Path Prefix based on depth
let PATH_PREFIX = '';
if (window.location.pathname.includes('/portfolio/quests/')) {
    PATH_PREFIX = '../../';
}

const NAV_LINKS = [
    { label: 'Home', href: 'index.html', path: '/' },
    { label: 'Work', href: 'work_speaker.html', path: '/work' }, // Updated default work link to speaker as hub
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div class="space-y-6">
                    ...
                    <p class="text-neutral-500 text-sm leading-relaxed">
                        6x Founder & Keynote Speaker.<br/>
                        Building <span class="text-green-400">Layer 1</span>.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3 text-sm text-neutral-400 bg-neutral-900/50 p-4 rounded-xl border border-neutral-800">
                        ...
                        <span>Open for <span class="text-white font-bold">Keynotes</span></span>
                    </div>
                </div>
            </div>
