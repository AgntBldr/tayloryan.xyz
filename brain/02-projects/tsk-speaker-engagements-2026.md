...
Standard deploy sync ran successfully; unrelated generated changes were reverted. Browser checks confirm list order, upcoming label, moderator role and workshop details. Deployment pending on branch `codex/speaker-engagements-2026`.
